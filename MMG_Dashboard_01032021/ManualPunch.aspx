<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ManualPunch.aspx.cs" Inherits="MMG_Dashboard_01032021.ManualPunch" %>
                                ...
                                <asp:Panel ID="pnlSearch" runat="server">
                                    ...
                                    <div class="row">
                                     ...
                                     <%--   <div class="col-md-2 form-group">
                                        ...
                                        <div class="col-md-4 form-group" style="padding-top: 20px; text-align: center;">
                                ...
                                <asp:Panel ID="pnlAddNew" runat="server">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <asp:TextBox ID="txtCustName" runat="server" CssClass="form-control input-sm" placeholder="Customer Name"
                                                MaxLength="100" />
